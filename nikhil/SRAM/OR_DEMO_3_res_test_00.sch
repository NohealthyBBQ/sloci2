...
C {devices/vsource.sym} -1100 130 0 0 {name=v1 value="pulse(0 0 25ns 30ps 30ps 5ns    )"}
C {devices/vsource.sym} -830 130 0 0 {name=v3 value="pulse(1.8 1.8 25ns 30ps 30ps 5ns   )"}
