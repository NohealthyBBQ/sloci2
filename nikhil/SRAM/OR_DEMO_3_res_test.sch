...
C {devices/vsource.sym} -1100 130 0 0 {name=v1 value="pulse(1.8 0 5ns 30ps 30ps 5ns    )"}
C {devices/vsource.sym} -830 130 0 0 {name=v3 value="pulse(0 1.8 5ns 30ps 30ps 5ns   )"}
C {devices/gnd.sym} -830 180 0 0 {name=l38 lab=GND}
C {devices/gnd.sym} -1100 180 0 0 {name=l40 lab=GND}
C {devices/lab_pin.sym} -830 100 0 0 {name=l28 sig_type=std_logic lab=BL}
C {devices/lab_pin.sym} -1100 100 0 0 {name=l29 sig_type=std_logic lab=BLB}
