...
C {devices/vsource.sym} -1810 240 0 0 {name=v11 value="pulse(1.8 0 50ns 30ps 30ps 15ns 50ns  )"}
C {devices/vsource.sym} -1540 240 0 0 {name=v12 value="pulse(0 1.8 50ns 30ps 30ps 15ns 50ns )"}
C {devices/gnd.sym} -1540 290 0 0 {name=l28 lab=GND}
C {devices/gnd.sym} -1810 290 0 0 {name=l29 lab=GND}
C {devices/lab_pin.sym} -1540 210 0 0 {name=l2 sig_type=std_logic lab=BL}
C {devices/lab_pin.sym} -1810 210 0 0 {name=l3 sig_type=std_logic lab=BLB}
