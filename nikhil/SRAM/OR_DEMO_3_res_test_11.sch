...
C {devices/lab_pin.sym} -510 500 1 0 {name=l58 sig_type=std_logic lab=WLB_C}
C {devices/lab_pin.sym} -740 520 1 0 {name=l59 sig_type=std_logic lab=WL_C}
C {devices/lab_pin.sym} -1700 520 1 0 {name=l2 sig_type=std_logic lab=WL_A}
C {devices/lab_pin.sym} -1470 500 1 0 {name=l3 sig_type=std_logic lab=WLB_A}
C {devices/lab_pin.sym} -1210 520 1 0 {name=l30 sig_type=std_logic lab=WL_B}
C {devices/lab_pin.sym} -980 500 1 0 {name=l32 sig_type=std_logic lab=WLB_B}
C {devices/vsource.sym} -1100 130 0 0 {name=v1 value="pulse(1.8 0 25ns 30ps 30ps 5ns    )"}
C {devices/vsource.sym} -830 130 0 0 {name=v3 value="pulse(0 1.8 25ns 30ps 30ps 5ns   )"}
C {devices/gnd.sym} -830 180 0 0 {name=l38 lab=GND}
C {devices/gnd.sym} -1100 180 0 0 {name=l40 lab=GND}
C {devices/lab_pin.sym} -1100 100 0 0 {name=l28 sig_type=std_logic lab=BL}
C {devices/lab_pin.sym} -830 100 0 0 {name=l29 sig_type=std_logic lab=BLB}
