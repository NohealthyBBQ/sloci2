...
C {devices/vsource.sym} -1140 260 0 0 {name=v1 value="pulse(1.8 0 5ns 30ps 30ps 5ns 10ns  )"}
C {devices/vsource.sym} -870 260 0 0 {name=v3 value="pulse(0 1.8 5ns 30ps 30ps 5ns 10ns )"}
...
C {devices/lab_pin.sym} -740 520 1 0 {name=l38 sig_type=std_logic lab=WLB_C}
C {devices/vsource.sym} -510 590 0 0 {name=v8 value="pulse(0 2.2 25ns 30ps 30ps 5ns 20ns  )"}
C {devices/lab_pin.sym} -510 500 1 0 {name=l40 sig_type=std_logic lab=WL_C}
...
C {devices/lab_pin.sym} -1470 500 1 0 {name=l34 sig_type=std_logic lab=WLB_A}
C {devices/lab_pin.sym} -1700 520 1 0 {name=l36 sig_type=std_logic lab=WL_A}
C {devices/lab_pin.sym} -980 500 1 0 {name=l59 sig_type=std_logic lab=WLB_B}
C {devices/lab_pin.sym} -1210 520 1 0 {name=l61 sig_type=std_logic lab=WL_B}
C {devices/lab_pin.sym} -870 230 0 0 {name=l29 sig_type=std_logic lab=BL}
C {devices/lab_pin.sym} -1140 230 0 0 {name=l32 sig_type=std_logic lab=BLB}
