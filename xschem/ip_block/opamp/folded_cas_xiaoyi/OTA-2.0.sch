...
"}
C {vsource.sym} 260 -360 0 0 {name=V6 value=1.8}
C {gnd.sym} 260 -300 0 0 {name=l5 lab=GND}
C {sky130_fd_pr/pfet_01v8_lvt.sym} -190 -350 0 1 {name=M8
L=1
W=3
nf=1
mult=12
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} -10 -350 0 0 {name=M5
L=2
W=3
nf=1
mult=80
